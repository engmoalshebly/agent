...
9. **cancel** - **فقط** إذا صرّح المستخدم بوضوح أنه يريد الإلغاء (ألغي، توقف، ما أبي أكمل). الغضب أو الاستياء وحده ليس إلغاء!
...
✅ إذا المستخدم يُعبر عن **رغبة صريحة بالإلغاء** (ألغي/توقف/ما أريد أكمل) = cancel
...
═══════════════════════════════════════
⚠️ قواعد مهمة جداً - الإحباط ليس إلغاء!
═══════════════════════════════════════

🔴 **مهم جداً**: إذا المستخدم **يقدم بيانات** (رقم هوية، تاريخ ميلاد، بيانات سيارة) 
    حتى لو كان مستاءً أو غاضباً = **provide_profile_data** أو **provide_vehicle_data**
    
🔴 الإهانات أو الشتائم المصاحبة للبيانات = تجاهلها واعتبرها provide_data
🔴 "مالك" أو "ما دخلك" قبل إعطاء البيانات = استياء لكن إذا تبعها بيانات = provide_data
🔴 فقط إذا المستخدم يقول بوضوح "الغي" أو "توقف" أو "ما أبي أكمل" = cancel
🔴 إذا المستخدم يقول "تمام" أو "كمل" أو "استمر" = confirm وليس cancel!
