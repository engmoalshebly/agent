...
📄 تفاصيل الوثيقة:
- رقم الوثيقة: POL-{context.policy_id or 'جاري الإصدار...'}
- الشركة: {offer.get('company', 'غير محدد')}
- نوع التغطية: {offer.get('type', 'غير محدد')}
- صلاحية الوثيقة: سنة من تاريخ اليوم

تعليمات مهمة:
- هنئ العميل بإتمام العملية
- أعطه رقم الوثيقة
- اخبره أن الوثيقة ستصله على الجوال/الإيميل
- اسأله إذا يحتاج أي مساعدة أخرى
...
📄 رقم الوثيقة: POL-{context.policy_id or '98765'}
🛡️ التغطية: {offer.get('type', 'تأمين شامل')}
📅 صالحة حتى: {self._get_expiry_date()}

الوثيقة راح توصلك على الجوال والإيميل خلال دقائق!
